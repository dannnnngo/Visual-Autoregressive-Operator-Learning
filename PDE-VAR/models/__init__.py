...
from .pdevar import PDEVAR
from .vqvae import VQVAE

__all__ = ['VectorQuantizer2', 'VQVAE', 'PDEVAR']

def build_vae_var(
    # Shared args
    device, patch_nums=(1, 4, 8, 16),   # 10 steps by default
    # VQVAE args
    ...
    var_wo_ddp = PDEVAR(
        vae_local=vae_local,
        depth=depth, embed_dim=width, 
        num_heads=heads, drop_rate=0., attn_drop_rate=0., drop_path_rate=dpr,
